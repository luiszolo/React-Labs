...
export default class AdminTests extends React.Component{
    ...
    componentDidMount() {
        const testsURL= "http://10.2.1.81:4000/api/tests/by";
        const attributesURL= "http://10.2.1.81:4000/api/attributes/by";
        const statusURL= "http://10.2.1.81:4000/api/status/by";
    ...
    handleSubmitTest(event){
        ...
        if(this.state.selectedTest === 'Add test') {
            axios.post(`http://10.2.1.81:4000/api/tests/add`, {
                test: {
