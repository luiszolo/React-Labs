...
export default class AdminAtrributes extends React.Component{
    ...
    componentDidMount(){
        const url= "http://10.2.1.81:4000/api/attributes/by";
    ...
    handleSubmitAttribute(event){
        ...
        if(this.state.selectedAttribute === ''){
            axios.post(`http://10.2.1.81:4000/api/Attributes/add`, {
                attribute: {
            ...
            axios.put(`http://10.2.1.81:4000/api/Attributes/find/${this.state.selectedAttribute.id}`, {
                attribute: {
                    name: this.state.name,
                    unit: this.state.unit,
                    placeholder: this.state.placeholder,
